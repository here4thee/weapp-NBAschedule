...
App({
  onLaunch: function () {
    ...
    // real test cases
    wx.request({
      url: 'https://op.juhe.cn/onebox/basketball/nba' + '?' + 'dtype=&key=APPID',
      success: function (res) {
        utils.saveDataToStorage('schedule:', res.data);
      }
    })

    // pre-defined test case
    // utils.saveDataToStorage('schedule:', testData);

    // test error page
    // utils.saveDataToStorage('schedule:', []);
  }
})